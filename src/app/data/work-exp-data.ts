export const workExperience = [
  ...
  },
  {
    ...
    achievments: [
      "The senior staff and investors members wanted quick summary statistics. Wrote an automated email script that sent over data visualisations in daily, weekly and monthly periods. This provided a snapshot overview of the companies performance that drove company decision.",
      "Code base for visualisation tool was sub-optimal, strongly coupled and unreadable. I rewrote the app as a greenfield project."
    ],
    duties: [
      [
        "Front End",
        "Used JavaScript & Jquery, HTML & CSS and various graphing libraries to create front-end scripts that visualised the behaviour of around 150 customers."
      ],
      [
        "Back End",
        "Wrote server side code with the Python web framework Pyramid. The server application gathered data from RESTful APIs and processed, aggregated & analysed it using self-written bespoke modules and third party libraries."
      ],
      [
        "Automation",
        "Created automated scripts that emailed the senior staff daily, weekly and monthly customer statistics reports."
      ],
      [
        "Maintenance",
        "Spent time reading the code base to fix bugs, refactor code and find & flag up architectural issues."
      ],
